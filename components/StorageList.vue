...
<template>
    <div class="container py-24 shrink-0">
            ...
            <UCard v-for="storage in storageZones">
                <div class="flex justify-center items-center flex-col gap-6">
                    ...
                    <div class="flex justify-between items-center w-full shrink-0">
                        <UButton color="error" square variant="soft" @click="deleteStorage(storage.Id)" icon="i-ph-trash-light">
                        </UButton>
                        <UButton size="md" color="primary" variant="outline" class="shrink-0" :to="`/${storage.Id}`">
                            View</UButton>
                    </div>
                </div>
            </UCard>
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <UButton color="error" variant="soft" @click="deleteAllStorages">
